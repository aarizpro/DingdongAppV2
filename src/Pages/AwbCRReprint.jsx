  ...
  return (
    ...
    <div className="my-3">
      <div ref={printRef} className="border border-dark p-3 bg-white">
        ...
        <div className="row mb-1 border border-dark ">
          ...
          <div className="col-md-6 border border-dark fw-bold " style={{ fontSize: '1.500em' }}>
            <strong>To:</strong><br />
            {receiverName}<br />
            {toAddr}<br />
            {toPincode}<br />
        ...
        <div className="row mb-1 text-lg font-weight-bold border border-dark ">
